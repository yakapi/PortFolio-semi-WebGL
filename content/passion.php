    ...
    <div class="block-passion-music">
      ...
      <div id="block-music-zone" class="block-music-zone">
        <div id="arrow-left-music" class="arrow-left-music">
          <p class="name-title spec-msize"><</p>
        </div>
        <div class="over-zone-music">
          <div class="zone-music">
            <?php require 'zone-musique.php' ?>
          </div>
        </div>
        <div id="arrow-right-music" class="arrow-right-music">
          <p class="name-title spec-msize">></p>
        </div>
      </div>
    </div>
  ...
  <div class="passion-festival">
    <div class="block-passion-festival">
      ...
      <div class="block-zone-festival">
        ...
        <div class="over-zone-festival">
          <div class="zone-festival">
            <?php require 'zone-festival.php' ?>
          </div>
        </div>
        <div id="arrow-right-festival" class="arrow-right-music">
          <p class="name-title spec-msize">></p>
        </div>
      </div>
    </div>
