<?php
$menu = true;
$content_foot = 'Passion';
$competene_color = '#370B20';
 ?>
<!DOCTYPE html>
<html lang="fr" dir="ltr">
  ...
  <body>
    <header id="header-passion" class="header-passion">
      <!-- WebGL -->
      <canvas id="scene-container"></canvas>
      <div id="star-container"></div>
      <!-- Contenu Central -->
      <div id="content-container-passion">
        <?php require 'content/passion.php' ?>
      </div>
      <!-- Barre Social -->
      <div id="social-bar">
    ...
    <script type="text/javascript" src="js/script-passion.js"></script>
    <script type="text/javascript" src="js/burger.js"></script>
    <script type="text/javascript" src="js/sizer-passion.js"></script>
  </body>
</html>
